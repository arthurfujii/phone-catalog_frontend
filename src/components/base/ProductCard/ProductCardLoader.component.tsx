export const ProductCardLoader = () => (
  <div className="cardLoader">
    <div className="cardLoader__image">
      <svg
        className="fpo "
        width="84px"
        height="63px"
    ...
    <div className="block1 pulsate" />
    <div className="block2 pulsate" />
    <div className="line" />
    <div className="cardLoader__specs">
      <div className="block3 pulsate" />
      <div className="block3 pulsate" />
      <div className="block3 pulsate" />
    </div>
    <div className="cardLoader__buttons">
      <div className="button--L pulsate" />
      <div className="button--S pulsate" />
    </div>
  </div>
);
